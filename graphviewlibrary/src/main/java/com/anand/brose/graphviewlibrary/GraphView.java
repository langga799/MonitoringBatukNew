...
public class GraphView extends HorizontalScrollView {
    ...
    private double graphXOffset = 1.0;//X position to start plotting posii start draw garis
    private int timeScale = 1 * 1000;//Put time marker for every 5 sec
    private int maxAmplitude = 48000;//Maximum possible amplitude
    ...
    private int graphColor = Color.rgb(41, 29, 203);
    private int timeColor = Color.rgb(0, 0, 0);
    ...
    private class GraphSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
        ...
        public void init(Context context) {
            ...
            this.setLayoutParams(new FrameLayout.LayoutParams(300, 2000));
